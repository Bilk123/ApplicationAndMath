...
import core.debug.MatrixNotSquareException;

@SuppressWarnings({"WeakerAccess"})
public abstract class SquareMatrix extends Matrix {
	private static final long serialVersionUID = -1645518685963391992L;
	...
	protected static float[][] initIdentity(int n) {
	...
	protected static float[][] inverse(float[][] a) {
